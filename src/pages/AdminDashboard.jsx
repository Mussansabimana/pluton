...
export default function AdminDashboard() {
  ...
  const navItems = [
    ...
    { id: 'applicants', name: 'Companies', icon: UsersIcon },
    { id: 'reports', name: 'Sudents', icon: DocumentTextIcon },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="h-8 w-8 rounded-full bg-gradient-to-r hover:shadow-md shadow-blue-400 cursor-pointer hover:scale-105 transition-all duration-200 ease-in-out from-blue-500 to-indigo-600 flex items-center justify-center text-white font-semibold">
      ...
      <div className=' relative flex min-h-max h-full'>
        {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0 transition-transform duration-200 ease-in-out z-40 w-64 bg-white/70 backdrop-blur-md shadow-lg md:shadow-none`}>
          ...
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-xl p-6 mt-6">
                  ...
                  <div key={item} className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md overflow-hidden border border-gray-100 hover:shadow-lg transition-shadow">
                    <div className="p-6">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <h3 className="text-lg font-medium text-gray-900">Software Developer Intern</h3>
                        ...
                        <tr key={item} className="hover:bg-gray-50">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              ...
                              <div className="ml-4">
                                <div className="text-sm font-medium text-gray-900">John Doe {item}</div>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                              item === 1 ? 'bg-blue-100 text-blue-800' : 
                              item === 2 ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'
                            }`}>
                              {item === 1 ? 'New' : item === 2 ? 'Review' : 'Interview'}
                            </span>
                          </td>
            ...
            {activeTab === 'reports' && (
              <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md overflow-hidden border border-gray-100 p-6">
                <h2 className="text-lg font-medium text-gray-900 mb-6">Internship Reports</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {['Performance', 'Attendance', 'Feedback', 'Completion'].map((report, index) => (
                    <div key={report} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <h3 className="text-lg font-medium text-gray-900">{report} Report</h3>
                          <p className="text-sm text-gray-500">Download {report.toLowerCase()} data</p>
                        </div>
                      </div>
                      <div className="mt-4">
            ...
            {activeTab === 'analytics' && (
              <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md overflow-hidden border border-gray-100 p-6">
                <h2 className="text-lg font-medium text-gray-900 mb-6">Internship Analytics</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                  <div className="bg-blue-50 rounded-lg p-4">
                    <h3 className="text-sm font-medium text-blue-800">Total Applicants</h3>
                    <p className="text-2xl font-bold text-gray-900">142</p>
                    <p className="text-xs text-blue-600 mt-1">↑ 12% from last month</p>
                  </div>
                  <div className="bg-green-50 rounded-lg p-4">
                    <h3 className="text-sm font-medium text-green-800">Active Interns</h3>
                  ...
                  <div className="bg-purple-50 rounded-lg p-4">
                    ...
                    <p className="text-xs text-purple-600 mt-1">↑ 5% from last year</p>
                  </div>
                </div>
