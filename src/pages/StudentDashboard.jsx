...
export default function StudentDashboard() {
  ...
  const notifications = [
    {
      name: "Internship",
      Description: "new internship added by",
      trade: "sotware development",
      status: "unreaded",
    },
    {
      name: "Internship",
    ...
    {
      name: "Internship",
      Description: "new internship added byhhhhhhhhhhhhhhhhhhhhhhhhhhh",
      trade: "sotware development",
      status: "unreaded",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4 relative">
              <button
                ...
                className={`${
                  activeNav === "notifications" ? "bg-blue-100" : ""
                } p-2 cursor-pointer rounded-full hover:bg-blue-100 text-gray-700`}
              >
              ...
              <button
                ...
                className={`${
                  activeNav === "settings" ? "bg-blue-100" : ""
                } p-2 cursor-pointer rounded-full hover:bg-blue-100 text-gray-700`}
              >
              ...
              <button
                ...
                className={`${
                  activeNav === "profile" ? "bg-blue-100" : ""
                } ring-1 ring-gray-400 hover:bg-blue-100 transition-all ease-in-out duration-200 rounded-full p-1`}
              >
                <UserIcon className="h-5 w-5" />
              </button>

              {activeNav === "notifications" && (
                <div onBlur={()=>{setSidebarOpen(false)}} className="absolute flex flex-col border border-gray-200 bg-gradient-to-br from-blue-50 to-indigo-100 max-h-96 overflow-auto rounded-tl-2xl rounded-bl-2xl w-80 shadow-md top-16 right-0 p-3 space-y-2">
                  {notifications.map((item, i) => (
                    <div
                      key={i}
                      className="bg-white hover:shadow-lg border border-gray-100 flex flex-col cursor-pointer shadow-md rounded-md p-2 transition-all"
                    >
                      <div className="font-semibold text-slate-900">
                        New {item.name}
                      </div>
                      <div className="text-sm text-blue-600">{item.trade}</div>
      ...
      <div className=" relative flex min-h-max h-full">
        <div
          className={`fixed inset-y-0 left-0 h-screen transform ${
